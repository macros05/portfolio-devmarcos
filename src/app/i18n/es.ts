export const ES = {
  ...
  hero: {
    ...
    role: 'AI Engineer',
    tagline: 'Construyo productos donde la IA se siente nativa — RAG, agentes y LLMs en producción.',
  ...
  projects: {
    ...
    galleryHint: 'índice de trabajo',
    examples: 'ejemplos',
    openCase: 'abrir caso de estudio →',
    view: 'ver',
    category: 'categoría',
    detailSections: {
  ...
  lab: {
    kicker: '03 — Lab',
    title: 'Experimentos',
    intro: 'Juguetes gráficos sobre el mismo motor. Mueve el cursor para perturbar el campo.',
    hint: 'hover / arrastra',
    items: {
      curl: { title: 'Curl Noise Flow', blurb: 'Ruido curl sin divergencia advectando un campo de puntos.' },
      sdf: { title: 'Raymarched SDF', blurb: 'Una superficie de distancia con signo marchada por píxel en un fragment shader.' },
      lattice: { title: 'Instanced Lattice', blurb: 'Miles de celdas instanciadas ondulando sobre una onda de ruido.' },
      feedback: { title: 'Feedback Buffer', blurb: 'Realimentación ping-pong pintando estelas persistentes de luz.' },
    },
  },
  contact: {
    kicker: '04 — Contacto',
    ...
    success: 'mensaje transmitido — te responderé en breve.',
    error: 'fallo en la transmisión — inténtalo de nuevo.',
  },
  footer: {
    rights: '© 2026 Marcos Morales. Todos los derechos reservados.',
    viewSource: 'ver código',
    builtWith: 'Hecho con Angular + three.js',
